        ...
        <div id="contact" className="mt-4">
            ...
            <div className="contact-me">
                <div className="social-media">
                    ...
                    <a href="/" target="_blank" rel="noopener noreferrer"><img className="social-media-icons" src={facebook} alt="facebook" /></a>
                    <a href="/" target="_blank" rel="noopener noreferrer"><img className="social-media-icons invert-1" src={twitter} alt="twitter" /></a>
