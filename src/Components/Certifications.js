...
export default function Certifications() {
  const certificates = [
    {
      courseName: "AI Fluency: Framework & Foundations",
      vendor: "Anthropic",
      link: "https://verify.skilljar.com/c/kwo4a69aggaj",
    },
    {
      courseName: "GitHub Copilot",
      vendor: "GitHub",
      link: "https://www.credly.com/badges/31a60fe2-c482-4cc0-8e6a-fcb3b3061d3e/linked_in_profile",
    },
    {
        ...
        {certificates.map((element) => {
          return (
            <div
              ...
              className="card col-lg-3 p-0 col-md-5"
            >
              <div className="card-body text-dark">
                <blockquote className="blockquote mb-0">
                  ...
                  <footer className="blockquote-footer">
                    Obtained from:{" "}
                    <cite className="text-muted fw-bold" title={element.vendor}>
                      {element.vendor}
                    </cite>
                  </footer>
                </blockquote>
